...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Konwerter XML → CSV (osobne pliki)")
        self.resize(760, 640)
    ...
    def _build_ui(self):
        ...
        subtitle = QLabel(
            "Pobierz wiele feedów XML jednocześnie i zapisz każdy do osobnego pliku CSV."
        )
        ...
        self.run_btn = QPushButton("Przetwórz na OSOBNE pliki CSV")
    ...
    def _reset_run_button(self):
        ...
        self.run_btn.setText("Przetwórz na OSOBNE pliki CSV")
